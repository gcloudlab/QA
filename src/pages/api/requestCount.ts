...
export const get: APIRoute = async () => {
  try {
    ...
    const res = await fetch(
      `https://api.vercel.com/v4/usage/top?owner_id=${vercelTeamId}&teamId=${vercelTeamId}&from=2023-02-16T16%3A00%3A00.000Z&to=${isoDate}&limit=5&sortKey=requests&pathType=request_path&projectId=${vercelPrjId}`,
      {
        headers: {
