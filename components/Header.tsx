    ...
    <header className="md:flex text-center justify-between items-center w-full mt-5 pb-7 sm:px-4 px-2">
      ...
      <div>
        <div className="flex flex-wrap justify-center gap-4 items-center">
          <a
            className="flex max-w-fit items-center justify-center space-x-2 rounded-md border border-gray-300 bg-fan1 px-4 py-2 text-sm text-gray-600 shadow-sm transition-colors hover:bg-fan"
